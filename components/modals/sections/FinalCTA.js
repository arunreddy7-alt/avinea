            ...
            <Reveal>
              <div className="space-y-8">
                ...
                <p className="body-lg text-white/60 max-w-xl leading-loose font-light text-base">
                  Don't just dream about a better life. Live it. Schedule your
                  viewing today and take the first step.
                </p>
              </div>
            </Reveal>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-4">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-white/5 border border-white/10 focus:border-accent focus:outline-none text-white transition-colors rounded-lg appearance-none cursor-pointer"
                    >
                      <option value="" className="bg-[#1a1a1a]">
                        Select configuration
                      </option>
                      <option value="2 BHK" className="bg-[#1a1a1a]">
                        2 BHK
                      </option>
                      <option value="3 BHK" className="bg-[#1a1a1a]">
                        3 BHK
                      </option>
                      <option value="4 BHK" className="bg-[#1a1a1a]">
                        4 BHK
                      </option>
                    </select>
                    <select
                    ...
                    >
                      ...
                      <option
                        value="Rs. 1.2 Cr - Rs. 1.5 Cr"
                        className="bg-[#1a1a1a]"
                      >
                        Rs. 1.2 Cr - Rs. 1.5 Cr
                      </option>
                      <option
                        value="Rs. 1.5 Cr - Rs. 2 Cr"
                        className="bg-[#1a1a1a]"
                      >
                        Rs. 1.5 Cr - Rs. 2 Cr
                      </option>
                      <option value="Rs. 2 Cr+" className="bg-[#1a1a1a]">
                        Rs. 2 Cr+
                      </option>
                    </select>
                    <select
                    ...
                    >
                      ...
                      <option
                        value="Immediately (0-3 months)"
                        className="bg-[#1a1a1a]"
                      >
                        Immediately (0-3 months)
                      </option>
                      <option value="3-6 months" className="bg-[#1a1a1a]">
                        3-6 months
                      </option>
                      <option value="6-12 months" className="bg-[#1a1a1a]">
                        6-12 months
                      </option>
                    </select>
                    <select
                    ...
                    >
                      ...
                      <option
                        value="Yes. this weekend"
                        className="bg-[#1a1a1a]"
                      >
                        Yes, this weekend
                      </option>
                      <option value="Yes, next week" className="bg-[#1a1a1a]">
                        Yes, next week
                      </option>
                      <option
                        value="Need more details first"
                        className="bg-[#1a1a1a]"
                      >
