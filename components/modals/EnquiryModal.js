        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        <div className="bg-[#1a1a1a] pointer-events-auto w-full max-w-[300px] sm:max-w-md overflow-hidden flex flex-col shadow-2xl border border-white/10 max-h-[calc(100vh-5rem)] md:max-h-[85vh] rounded-xl md:rounded-2xl -mt-45 -ml-12 sm:mt-0">
                            {/* Modal Header */}
